...
class TodoList : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        txtCari = view.findViewById(R.id.editCari)
        ...
        fabAddData.setOnClickListener(View.OnClickListener {
            ...
            parentFragmentManager.beginTransaction()
                ...
                .replace(R.id.frmFragmentRoot, AddTodoList.newInstance("add", UjianItem()))
                .commit()

        })
        btnCari.setOnClickListener(View.OnClickListener {
            getAllDataByFilter(UjianItem("",txtCari.text.toString(),"", ""))
        })
    ...
    fun getAllDataByFilter(data : UjianItem){
        ...
        client.enqueue(object : Callback<ResponseGetAllData> {
            override fun onResponse(
                ...
                if (response.isSuccessful && responseBody != null) {
                    ...
                    todoListAdapter = TodoListAdapter(responseBody.data?.ujian!!, {item ->
                        parentFragmentManager.beginTransaction()
                            .addToBackStack("add form")
    ...
    fun deleteDataTodoList(data : UjianItem){
